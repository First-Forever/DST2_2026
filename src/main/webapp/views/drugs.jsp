...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form action="<%=request.getContextPath()%>/drugs" method="get" class="kb-filter-form">
                ...
                <div class="kb-filter-actions" style="padding-top: 1.75rem;">
                    ...
                    <a href="<%=request.getContextPath()%>/drugs" class="btn btn-outline-secondary btn-sm">Reset</a>
                </div>
            </form>
